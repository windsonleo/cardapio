...
//			elem2.addClass('socialPlugin');
//			elem2.append('<div class="fb-login-button" data-width="235" data-size="large" data-button-type="login_with" data-auto-logout-link="true" data-use-continue-as="false" data-onlogin="checkLoginState()" data-scope="public_profile,email"></div>');
//			elem2.append('<span class="socials"></span>');

			// Generate the share buttons

			var socialButtonsPopUp = elem.find('.socials');
			
			var socialButtonsPopUpEnter = elem.find('.socials');
			...
			if(options.facebook){
				socialButtonsPopUpEnter.append($('<a class="fa fa-facebook" href="#" onclick="checkLoginState();"> <div class="fb-login-button" data-width="80" data-size="medium" data-button-type="login_with" data-auto-logout-link="false" data-use-continue-as="false" data-onlogin="checkLoginState()" data-scope="public_profile,email"></div> </a>'));
			}
			

			if(options.googlePlus){
				socialButtonsPopUpEnter.append($('<a class="fa fa-google-plus" href="#" onclick="renderButton()"> <div id="my-signin2"></div> </a>'));
			}
...
//		socialLength2 = socials.find('div').length,
//		marginLeft = '-35';
...
//		socials.width(socialLength2 * 110).css({'margin-left': marginLeft - ((socialLength2-1) * 55)});
